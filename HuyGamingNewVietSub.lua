...
local Window = OrionLib:MakeWindow({Name = "Z-axure Hub👹👹", HidePremium = false, IntroText = "Sì cờ ríp Của bạn đây:))))😘", SaveConfig = true, ConfigFolder = "W-huy Gaming Hub"})
----------Tab-----------------------
local W = Window:MakeTab({
    Name = "Thông Tin Của Bạn Nek!!!😘",
